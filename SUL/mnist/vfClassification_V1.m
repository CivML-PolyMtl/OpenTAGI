%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File:         vfClassification_V1
% Description:  test visual field classification on mnist
...
ntrain      = 10;
ntest       = 10;
[ytrain, ytest, labelTest] = dp.prepareData4visualField(x(trainIdx), x(testIdx), yref(trainIdx), yref(testIdx), ntrain, ntest, classes);
...
%% Run
task.runVFclassification(net, z, ytrain, ytest, labelTest, trainedModelDir, initModelDir, initEpoch);
